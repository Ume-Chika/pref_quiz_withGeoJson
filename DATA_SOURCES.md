...
本リポジトリでは `scripts/build-boundaries.mjs` により、日本の47都道府県をISO 3166-2コードで抽出し、Douglas–Peucker法（許容差0.005度）による簡素化、約0.001平方度未満の小ポリゴン除外、座標の小数5桁化、都道府県コードと名称の付与を行いました。

出力は47件、127,528バイト、Polygon 33件、MultiPolygon 14件、119ポリゴン、5,841点です。範囲は `[122.93865, 24.25825, 145.82496, 45.52041]`、SHA-256は `8b9171fb19a9d51d113361a8b93aa46470b5b11055195040485a8d8e68b1b5ed` です。
...
- 出力: 6,333バイト、SHA-256 `c0f9928cde313b941a73011fd719837b961b7b6d4fedc832334475985656702e`
